...
function init() {
    ...
    <div class='chat-popup'>
		...
		<div class='chat-input-area'>
			<input type='text' autofocus class='chat-input' onkeypress='return givenUserInput(event)' placeholder='ഒരു സന്ദേശം ടൈപ്പ് ചെയ്യുക.' autocomplete='off'>
			<button class='chat-submit'><i class='material-icons'>send</i>
            <button class='chat-mic'><i class='material-icons'>mic</i></button>
            <button class='attach-mic' disabled><i class='material-icons'>stop</i></button>
		</div>
      ...
      .then((stream) => {
        ...
        mediaRecorder.onstop = (e) => {
          ...
          chunks.forEach((chunk) => {
            formData.append("audio_data", chunk);
          });
          ...
          $.ajax({
            ...
            success: function(response) {
              // The recorded audio has been successfully uploaded to the Flask server.
              alert(response);
